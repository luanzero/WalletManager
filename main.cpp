...
int main() {
    ...
    DataManager::backupData("data/users.txt", "backup");
    return 0;
}
...
void userMenu() {
    ...
    do {
        ...
        cout << "3. Xem vi diem và lich su giao dich\n";
        cout << "4. Chuyen diem\n";
...
void adminMenu() {
    ...
    do {
        ...
        switch (choice) {
            ...
            case 2: createUserByAdmin(users); break;
            case 3: updateUserInfoByAdmin(users); break;
            case 4: manageUserWallet(users); break;
            case 5: viewGlobalWallet(); break;
            case 6: topUpGlobalWallet(); break;
            case 7: distributePointsFromGlobal(); break;
